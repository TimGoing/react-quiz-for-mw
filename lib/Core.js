...
var Core = function Core(_ref) {
  ...
  var renderAnswerInResult = function renderAnswerInResult(question, userInputIndex) {
    ...
    return _react.default.createElement("div", null, "11", console.log(userInput.toString(), allAnswers.filter(function (i) {
      return i.toString() === userInput.toString();
  ...
  return _react.default.createElement("div", {
    ...
    type: "button"
  }, answerIsSelected[questions.length - 1] ? "遞交" : appLocale.nextQuestionBtn))), endQuiz && showDefaultResultState && customResultPage === undefined && renderResult(), endQuiz && !showDefaultResultState && customResultPage !== undefined && customResultPage(questionSummary));
};
